...
def classify(leads):
    ...
    try:
        ...
        # torch opsional: tanpa torch, digitalisasi tetap jalan,
        # hanya skrining AI yang dilewati.
        print('  [INFO] PyTorch tidak terpasang -> lewati skrining AI '
              '(digitalisasi & FHIR tetap jalan). Pasang torch untuk AI.')
        return None
