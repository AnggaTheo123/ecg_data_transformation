...
CONTOH PEMAKAIAN
  # auto-deteksi jumlah lead, satu file:
  python proses_ekg.py --input 12-lead/20260604-153533/20251029-153616-0001.pdf

  # proses SATU FOLDER berisi banyak PDF 12-lead:
  python proses_ekg.py --folder 12-lead

  # paksa 12-lead, output ke folder tertentu:
  python proses_ekg.py --lead 12 --folder 12-lead --out hasil_12

  # tanpa gambar perbandingan (lebih cepat):
  python proses_ekg.py --folder 12-lead --no-compare
